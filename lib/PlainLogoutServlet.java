...
@WebServlet(name = "plainlogoutServlet", urlPatterns = {"/logout"})
public class PlainLogoutServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    response.sendRedirect(request.getContextPath() + "/IDwebapp/index.jsp");
